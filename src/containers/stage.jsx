...
class Stage extends React.Component {
    ...
    async handleCursor(e) {
        ...
        await channel.publish('mousemove', JSON.stringify(e));
    }
    stringifyMouseEvent(event) {
        const keysToExclude = [
            'currentTarget', 'explicitOriginalTarget', 'originalTarget', 'rangeParent', 'relatedTarget', 'srcElement', 'target', 'view'
        ];
        ...
        // Include non-enumerable properties but exclude large ones
        const nonEnumerableProps = [
            'altKey', 'bubbles', 'button', 'buttons', 'cancelable', 'clientX', 'clientY', 'ctrlKey',
            'defaultPrevented', 'detail', 'eventPhase', 'isTrusted', 'layerX', 'layerY',
            'metaKey', 'movementX', 'movementY', 'offsetX', 'offsetY', 'pageX', 'pageY',
            'rangeOffset', 'returnValue', 'screenX', 'screenY', 'shiftKey', 'timestamp', 'type'
        ];
